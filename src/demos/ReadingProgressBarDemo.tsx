...
export function ReadingProgressBarDemo() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8 space-y-10">
      ...
      <div>
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Reading Progress Bar</h1>
        <p className="mt-2 text-sm text-gray-500 leading-relaxed">
          Barra de progresso que acompanha a leitura de um artigo. Extraída do{" "}
      ...
      <section>
        ...
        >
          ...
          <p>
            ...
            Integer in mauris eu nibh euismod gravida. Duis ac tellus et risus vulputate vehicula. Donec lobortis risus a elit. Etiam tempor. Ut ullamcorper, ligula eu tempor congue, eros est euismod turpis, id tincidunt sapien risus a quam. Maecenas fermentum consequat mi. Donec fermentum. Pellentesque malesuada nulla a mi. Duis sapien sem, aliquet nec, commodo eget, consequat quis, neque. Aliquam faucibus, elit ut dictum aliquet, felis nisl adipiscing sapien, sed pretium diam manisl eget egestas. Fugiat dapibus, tellus ac cursus commodo, mauris sit condimena nibh, ut hendrerit nisi quamm r nisi.
          </p>
          <p>
            Praesent ac sem eget est egestas volutpat. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. 
            ...
            Vestibulum volutpat pretium libero. Cras id nisl. Suspendisse in justo eu magna luctus suscipit. Sed lectus. Integer euismod lacus luctus magna.
          </p>
          <p>
        ...
        <p className="text-xs text-gray-400 mt-3 text-center">↑ A barra aparece no TOPO da página ao scrollar este box ↑</p>
      </section>

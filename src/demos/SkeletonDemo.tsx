    ...
    <div className="max-w-2xl mx-auto px-6 py-8 space-y-10">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-500 leading-relaxed">
          Placeholder de loading com animação shimmer. Extraído do{" "}
      ...
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-4">Demo — Post card</h2>
      ...
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-4">Funcionalidades</h2>
